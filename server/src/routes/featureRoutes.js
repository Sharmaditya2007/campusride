...
const { getTimetable, updateTimetable, getCommuteGroups, createCommuteGroup, getEnvironmentalImpact, submitReport, triggerSOS } = require('../controllers/featureController');
