        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <Link to="/wallet" className="glass-card glass-card-hover p-6 rounded-3xl border-slate-800 space-y-3 block">
              ...
              <h3 className="text-base font-bold text-white">Wallet & Payments</h3>
              <p className="text-xs text-slate-400">View transaction ledger, add funds, and manage instant payments.</p>
